...
@section('content')
    ...
    @php
        /** @var \App\ViewModels\NewsViewModel $viewModel */

        $otherContents = method_exists($catalogService, 'getNews')
            ? $catalogService->getNews(app()->getLocale(), 10)
        ...
        <section class="aether-container">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 mt-5">
                ...
                @foreach($otherContents as $otherItem)
                    ...
                    @php /** @var \App\ViewModels\NewsViewModel $otherItem */ @endphp
