...
@section('content')
    ...
    @php
        /** @var \App\ViewModels\ProjectViewModel $viewModel */

        $otherContents = method_exists($catalogService, 'getProjects')
            ? $catalogService->getProjects(app()->getLocale(), 10)
        ...
        <section class="aether-container">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 mt-5">
                ...
                @foreach($otherContents as $otherItem)
                    ...
                    @php /** @var \App\ViewModels\ProjectViewModel $otherItem */ @endphp
