...
@section('content')
    ...
    <section class="aether-container">
        ...
        <div class="flex flex-col gap-4 mt-5">
            ...
            @if($viewModel->getCompletionDate())
                <span>
            ...
            @if($viewModel->getURL())
                <a href="{{ $viewModel->getURL() }}" target="_blank" rel="nofollow noreferrer">
                    {{ $viewModel->getURL() }}
                </a>
            @endif
    ...
    @php
        /** @var \App\ViewModels\ReferenceViewModel $viewModel */

        $otherContents = method_exists($catalogService, 'getReferences')
            ? $catalogService->getReferences(app()->getLocale(), 10)
        ...
        <section class="aether-container">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 mt-5">
                ...
                @foreach($otherContents as $otherItem)
                    ...
                    @php /** @var \App\ViewModels\ReferenceViewModel $otherItem */ @endphp
